// Regenerate components/promise-beats/*.tsx from the crisp *.svg path data.
// Copy-adapted from scripts/regen-nuuly-beats-tsx.mjs (repo rule: copy before generalizing;
// see the oku-svgr-single-source note for the deferred unification). Nuuly's was the
// copy to take rather than oku's or fdte's: it is the only one carrying the fill guard
// below, and this study's art comes off the same tracing pipeline that needed it.
...
//
//   node scripts/regen-promise-beats-tsx.mjs      (or: npm run regen:promise-beats)
//
...
const dir = new URL('../components/promise-beats/', import.meta.url);
...
// Generated from ${base}.svg by scripts/regen-promise-beats-tsx.mjs — do not edit by hand; rerun the script if the SVG changes.
